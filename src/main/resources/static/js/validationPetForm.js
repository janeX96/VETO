function validateForm() {
    ...
    if (!checkRequired(nameInput.value)) {
        ...
        valid = false;
        nameInput.classList.add("error-input");
        errorName.innerText = "Pole powinno zawierać od 2 do 30 znaków";
    }
    else
    ...
    } else if (!checkTextLengthRange(typeInput.value, 3, 60)) {
        valid = false;
        typeInput.classList.add("error-input");
        errorType.innerText = "Pole powinno zawierać od 3 do 60 znaków";
    }
    else
    ...
    } else if (!checkTextLengthRange(ownerFirstNameInput.value, 2, 30)) {
        valid = false;
        ownerFirstNameInput.classList.add("error-input");
        errorOwnerFirstName.innerText = "Pole powinno zawierać od 2 do 30 znaków";
    }
    else
        ownerFirstNameInput.classList.remove("error-input");
    ...
    if (!checkRequired(ownerLastNameInput.value)) {
        ...
        ownerLastNameInput.classList.remove("error-input");

    if (!checkRequired(phoneInput.value) || !"^\\d{9}$".test(phoneInput.value)) {
        valid = false;
